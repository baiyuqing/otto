...
//!
//! The REPL, `kite serve`, and a later TUI all drive one [`Controller`]: it
...
use kite_core::agent::{AgentError, CompactionResult, EventSink};
use kite_core::config::resolve::Runtime;
use kite_core::model::{Block, Message, Usage};
use kite_core::session::{ListResult, RuntimeMetadata, Session};
