...
//!
//! The wire codec lives in [`kite_core::openaicompat`]; this module owns only
...
use kite_core::openaicompat::overflow::{MAX_ERROR_BODY, classify_overflow};
use kite_core::openaicompat::protocol::{build_request, serialized_request_size};
use kite_core::openaicompat::stream::StreamAssembler;
...
mod tests {
    ...
    use kite_core::model::{Block, Message, Role};
