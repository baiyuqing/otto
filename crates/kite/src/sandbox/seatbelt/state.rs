...
pub(crate) const LEAF_PREFIX: &str = "kite-sandbox-";
...
/// Creates an `kite-sandbox-` leaf under `parent_file`, retrying on collision.
...
/// Whether `root` is a direct `kite-sandbox-` child of `parent`.
