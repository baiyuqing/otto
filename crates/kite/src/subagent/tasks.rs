...
//! [`kite_core::agent::tasks::TaskRegistry`], whose only method the turn loop
//! calls is `close`.
//!
...
use kite_core::agent::inbox::{Inbox, NotificationKind};
use kite_core::agent::tasks::TaskRegistry;
use kite_core::model::{Message, Usage};
...
mod tests {
    ...
    use kite_core::model::{Block, BlockType, Role};
