...
//!
//! Kite asks the terminal to report mouse events so the wheel can scroll the
...
//! the selection has to be Kite's own: this module tracks the drag, paints
...
impl Selection {
    ...
    /// [`super::gutter::strip_gutters`]: the markers are Kite's own framing,
...
///
/// ponytail: no SSH story. If Kite ever runs on a remote host, OSC 52 is
