...
//! canonicalized to valid UTF-8 by [`kite_core::safetext::canonicalize_utf8`].

use std::collections::HashSet;

use crate::gourl;
use kite_core::safetext;
...
/// are shared with [`kite_core::safetext`] so that a value rejected here is also one
