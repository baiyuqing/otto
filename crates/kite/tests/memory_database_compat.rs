//! Schema compatibility for `~/.kite/memory/memory.db`.
//!
...
use kite::memory::sqlite::{Options, Store};
use kite::memory::{ListRequest, NAMESPACE_USER, Origin, Provenance, Record, Scope, UpsertRequest};
