...
/// `otto-core` must build for wasm32 and so cannot depend on the crate that
/// owns the executor.
...
mod tests {
    use super::*;
    use otto_core::config::SandboxConfig;
    use otto_core::config::sandbox::resolve_sandbox;
